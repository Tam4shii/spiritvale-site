...
**Push/CI status**: commit 8e112c8 pushed to `origin/main` (2026-06-04 idle-loop Forge — Steam check timestamp + rebase fix). CF Pages NOT connected (Blocker #1 open) → pushes do **not** trigger deployments.
