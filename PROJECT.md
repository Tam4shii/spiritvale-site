...
**Last Steam check**: 2026-06-04T22:55:10Z (idle-loop Forge 2026-06-05) — ✅ No new patch notes; items_found=10; new_draft=false. **⚠️ ANNOUNCEMENT DETECTED**: `patches/draft-spiritvale-official-date-release.json` (version="0.0.0") — roadmap post (June 8 wipe, June 12 demo, July 15 EA ~$15 USD). Needs boss review; NOT auto-published.
**Next idle-loop action**: BOSS ACTION NEEDED — review `patches/draft-spiritvale-official-date-release.json`. Decide: (a) publish as announcement page, (b) archive/delete draft, (c) ignore. After decision, run `make check-steam` next cycle.
